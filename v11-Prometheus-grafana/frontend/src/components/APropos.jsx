...
function CrudModal({ mode, tabCfg, c, fields, form, saving, onChange, onSubmit, onClose }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 modal-overlay bg-slate-900/70 animate-fade-in" onClick={e => e.target === e.currentTarget && onClose()} onKeyDown={e => e.key === 'Escape' && onClose()}>
...
function ConfirmModal({ onConfirm, onCancel }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 modal-overlay bg-slate-900/70 animate-fade-in" onClick={e => e.target === e.currentTarget && onCancel()} onKeyDown={e => e.key === 'Escape' && onCancel()}>
